...
import { Avatar, Button, Card, CardContent, Divider, Grid, Link, List, ListItem, ListItemAvatar, ListItemIcon, ListItemText, Typography } from '@material-ui/core';
import {
    ...
    <Card>
      <CardContent>
        <Typography variant="h6">
          Repositories in {entity.metadata.name}
        </Typography>
